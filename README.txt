...
3. Run the echo server
   java -cp .:target/udp-echo-1.0-SNAPSHOT-jar-with-dependencies.jar ca.UDPServer --port 8007

4. Run the echo client
   java -cp .:target/udp-echo-1.0-SNAPSHOT-jar-with-dependencies.jar ca.UDPClient \

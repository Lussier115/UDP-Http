...
func usage() {
	fmt.Println(`
Router is a logical router dispatches ReliableUDP packets between applications.
It receives ReliableUDP packets, then dispatches to the associated destination of the packet.
